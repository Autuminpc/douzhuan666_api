...
return [
    ...
    'Server info'             => '服务器信息',
    'PHP version'             => 'PHP版本',
    'Fastorgan version'       => '主框架版本',
    'Fastorgan addon version' => '插件版本',
    ...
    'Language'                => '语言',
    'View more'               => '查看更多',
    'Security tips'           => '<i class="fa fa-warning"></i> 安全提示：你正在使用默认的后台登录入口，为了你的网站安全，强烈建议你修改后台登录入口，<a href="https://forum.fastorgan.net/thread/7640" target="_blank">点击查看修改方法</a>',
];
