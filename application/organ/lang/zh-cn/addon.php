...
return [
    ...
    'Login tips'                     => '此处登录账号为<a href="https://www.fastorgan.net" target="_blank">FastOrgan官网账号</a>',
    ...
    'Not login tips'                 => '你当前未登录FastOrgan，登录后将同步已购买的记录，下载时无需二次付费！',
    'Not installed tips'             => '请安装后再访问插件前台页面！',
    'Not enabled tips'               => '插件已经禁用,请启用后再访问插件前台页面！',
    'New version tips'               => '发现新版本:%s 点击查看更新日志',
    'Store now available tips'       => 'FastOrgan插件市场暂不可用，是否切换到本地插件？',
