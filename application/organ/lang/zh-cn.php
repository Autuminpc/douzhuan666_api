...
return [
    ...
    'Addon tips'                                            => '可在线安装、卸载、禁用、启用插件，同时支持添加本地插件。FastOrgan已上线插件商店 ，你可以发布你的免费或付费插件：<a href="https://www.fastorgan.net/store.html" target="_blank">https://www.fastorgan.net/store.html</a>',
    'Organ tips'                                            => '一个管理员可以有多个角色组,左侧的菜单根据管理员所拥有的权限进行生成',
    'Organ log tips'                                        => '管理员可以查看自己所拥有的权限的管理员日志',
