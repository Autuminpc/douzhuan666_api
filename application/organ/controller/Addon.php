 ...
 *
 * @icon   fa fa-cube
 * @remark 可在线安装、卸载、禁用、启用插件，同时支持添加本地插件。FastOrgan已上线插件商店 ，你可以发布你的免费或付费插件：<a href="https://www.fastorgan.net/store.html" target="_blank">https://www.fastorgan.net/store.html</a>
 */
class Addon extends Organend
{
    ...
    public function downloaded()
    {
        ...
        if (!is_array($onlineaddons)) {
            $onlineaddons = [];
            $result = Http::sendRequest(config('fastorgan.api_url') . '/addon/index');
            if ($result['ret']) {
