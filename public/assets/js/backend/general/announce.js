define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'general/announce/index' + location.search,
                    add_url: 'general/announce/add',
                    edit_url: 'general/announce/edit',
                    del_url: 'general/announce/del',
                    multi_url: 'general/announce/multi',
                    table: 'announce',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'general/announce/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
