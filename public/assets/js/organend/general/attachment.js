            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'organ_id', title: __('Organ_id'), visible: false, addClass: "selectpage", extend: "data-source='auth/organ/index' data-field='nickname'"},
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        {field: 'state', checkbox: true,},
                        {field: 'id', title: __('Id')},
                        {field: 'organ_id', title: __('Organ_id'), visible: false},
            ...
            formatter: {
                thumb: function (value, row, index) {
                    if (row.mimetype.indexOf("image") > -1) {
                        ...
                        return '<a href="' + row.fullurl + '" target="_blank"><img src="https://tool.fastorgan.net/icon/' + row.imagetype + '.png" alt=""></a>';
                    }
                },
