define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'auth/organlog/index',
                    add_url: '',
                    edit_url: '',
                    del_url: 'auth/organlog/del',
                    multi_url: 'auth/organlog/multi',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'account', title: __('Username'), formatter: Table.api.formatter.search},
